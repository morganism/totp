...
// Mirrors iPhoneAccountCard pattern: @State vars driven by tick() + refresh()
...
struct WatchAccountRow: View {
    ...
    var body: some View {
        ...
        .onAppear {
            tick()     // populate progress/secondsLeft immediately
            refresh()  // kick off first TOTP generation
        }
